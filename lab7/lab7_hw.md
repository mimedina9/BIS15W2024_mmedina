...
```r
fisheries_tidy %>% 
  select(country, common_name, year) %>% 
...
## # A tibble: 934 × 3
## # Groups:   year [63]
##    country common_name                   year
##    <fct>   <chr>                        <dbl>
##  1 Albania Angelsharks, sand devils nei  2012
##  2 Albania Atlantic bonito               2012
##  3 Albania Bogue                         2012
##  4 Albania Caramote prawn                2012
##  5 Albania Common cuttlefish             2012
##  6 Albania Common dentex                 2012
##  7 Albania Common octopus                2012
##  8 Albania Common sole                   2012
##  9 Albania Common spiny lobster          2012
## 10 Albania Common squids nei             2012
## # ℹ 924 more rows
```
